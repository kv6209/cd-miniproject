...
# starting label
start1 = Label(frame, text='CONTENT OPTIMISER', font=("Arial", 55,"underline"),fg="dark blue")
...
window.title("CONTENT OPTIMISER")
...
def summarize_fun():
    ...
    window1.title("CONTENT OPTIMISER")

    # top label
    start1 = tk.Label(window1,text="CONTENT OPTIMISER", font=("Arial", 55), fg="dark blue")  # same way bg
    start1.place(x=140, y=10)
    ...
    # second label
    sec1 = tk.Label(window1, text="ORIGINAL CONTENT LENGTH  :  " + str(len(text)), font=("Arial", 30), fg="green")  # same way bg
    sec1.place(x=185, y=550)

    # second label
    sec1 = tk.Label(window1, text="OPTIMISED CONTENT LENGTH  :  " + str(len(summary)), font=("Arial", 30), fg="green")  # same way bg
...
# top label
start1 = tk.Label(text = "CONTENT OPTIMISER", font=("Arial", 55), fg="dark blue") # same way bg
start1.place(x = 140, y = 10)

# second label
sec1 = tk.Label(text="Enter Any CONTENT ", font=("Arial", 30), fg="brown")  # same way bg
...
checkb = Button(window, text="OPTIMISE",command=summarize_fun,font=("Arial", 25), bg = "light green", fg = "blue", borderwidth=3, relief="raised")
